...
public class BackendBookItemController extends BaseController {
    ...
    public ResponseObject list(HttpServletRequest request, @ModelAttribute BookItemPage bookItemPage) throws BusinessCheckException {
    ...
    @CrossOrigin
    @PreAuthorize("@pms.hasPermission('book:index')")
    public ResponseObject saveHandler(HttpServletRequest request, BookItemDto bookItemDto) throws BusinessCheckException, ParseException {
        AccountInfo accountInfo = TokenUtil.getAccountInfoByToken(request.getHeader("Access-Token"));
